...
let crush = function (string, maxSubstringLength = 50) {
...
let uncrush = function (toUncrush) {
    // remove last character
    toUncrush = toUncrush.substring(0, toUncrush.length - 1);
    // unsplit the string using the delimiter
    const stringParts = toUncrush.split('\u0001');
    // JSUncrush algorithm
...
//# sourceMappingURL=json_crush.js.map